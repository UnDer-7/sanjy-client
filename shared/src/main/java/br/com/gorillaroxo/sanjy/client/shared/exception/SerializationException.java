...
public class SerializationException extends BusinessException {
    ...
    private static final ExceptionCode CODE = ExceptionCode.SERIALIZATION_FAIL;
    private static final HttpStatus STATUS = HttpStatus.INTERNAL_SERVER_ERROR;

    public SerializationException(final String customMessage, final Throwable originalCause) {
    ...
    public SerializationException(final Throwable originalCause) {
        super(CODE, STATUS, originalCause);
    }

    public SerializationException(final String customMessage) {
